...
<body>
	...
	<div class="container">
		...
		<h3>
			<sec:authentication property="principal"/> <!-- 보호된 대상에 접근하는 유저 -->
		</h3>
		
		<p>사용자 명 : <sec:authentication property="principal.username"/></p>
		<p>비밀번호 : <sec:authentication property="principal.password"/></p>
	
		<!-- 권한이 있는지 여부확인 -->
		<p>/member 에 접근할 수 있는지
		<sec:authorize url="/member" var="t">${t}</sec:authorize></p>
